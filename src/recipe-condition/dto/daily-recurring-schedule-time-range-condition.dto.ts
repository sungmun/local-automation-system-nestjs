...
export class DailyRecurringScheduleTimeRangeConditionDto extends BaseRecipeConditionDto {
  @ApiProperty({
    description: '조건 타입',
    enum: RecipeConditionType,
    example: RecipeConditionType.DAILY_RECURRING_SCHEDULE_TIME_RANGE,
  })
