import { ReserveTimeRangeConditionResponseDto } from './reserve-time-range-condition-response.dto';
...
describe('RecipeConditionReserveTimeRangeResponseDto', () => {
  it('DTO가 올바르게 변환되어야 합니다', () => {
    ...
    const dto = plainToInstance(ReserveTimeRangeConditionResponseDto, plain);
